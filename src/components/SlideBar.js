    ...
    <div className="flex-none  bg-black h-screen min-w-[25%] fixed ">
      <div className="nav flex  text-white text-lg mt-10 flex-col align-middle justify-center text-center w-full gap-5 overflow-hidden">
        <div data-aos="slide-down">
          <img
            src={require("../assets/images/AdityaPP.jpg")}
            alt="Aditya Kishor Dahal"
      ...
      >
        <div
          onClick={() =>
            window.open("https://github.com/adityadahal", "_blank")
          }
        >
        ...
        <div
          onClick={() =>
            window.open(
              "https://www.linkedin.com/in/aditya-kishor-dahal-5132a7236/",
              "_blank"
            )
          }
        >
